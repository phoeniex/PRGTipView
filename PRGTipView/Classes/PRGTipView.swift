...
public class PRGTipView: UIViewController {
  ...
  public init(configuration: PRGTipViewConfiguration) {
  ...
  public override func viewDidLoad() {
    ...
    if let buttonWidth = configuration.buttonWidth {
      ...
      let widthConstraint = NSLayoutConstraint(item: button, attribute: NSLayoutConstraint.Attribute.width,
                                               relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil,
                                               attribute: NSLayoutConstraint.Attribute.notAnAttribute, multiplier: 1, constant: buttonWidth)
      button.addConstraint(widthConstraint)
    } else {
      containerView.alignment = .fill
    }
    
    if let buttonHeight = configuration.buttonHeight {
      let heightConstraint = NSLayoutConstraint(item: button, attribute: NSLayoutConstraint.Attribute.height,
                                                relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil,
                                                attribute: NSLayoutConstraint.Attribute.notAnAttribute, multiplier: 1, constant: buttonHeight)
    ...
    titleLbl.textAlignment = configuration.titleAlignment
    ...
    textLbl.textAlignment = configuration.detailAlignment
